# AI Protocol Protocol Fee Distributor #
Accepts protocol fees from the bonding curve contracts and distributes them later to the list of recipients via the admin-push mechanism
...
* Smart Contract(s):
    * [ProtocolFeeDistributorV1](contracts/bonding_curves/ProtocolFeeDistributorV1.sol) – Protocol Fee Distributor V1 implementation
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/protocol-fee-distributor-contracts.git```
2. Navigate into the cloned repository  
    ```cd protocol-fee-distributor-contracts```
